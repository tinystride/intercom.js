...
g.createInterface("_handlers");g.prototype._on=n.on;g.prototype._off=n.off;g.prototype._trigger=n.trigger;var p=g.createInterface("handlers");g.prototype.on=function(){p.on.apply(this,arguments);Array.prototype.unshift.call(arguments,"on");this._trigger.apply(this,arguments)};g.prototype.off=p.off;g.prototype.trigger=p.trigger;var f=void 0;if(function(){try{return window.localStorage["local-storage-test"]=1,!0}catch(a){return!1}})f=window.localStorage;var k={};k.guid=function(){var a=function(){return(65536*
